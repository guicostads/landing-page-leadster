...
const Footer = () => {
  return (
    <footer className="flex flex-col justify-center pt-4 w-full">
      ...
      <div className="grid grid-cols-4 max-md:grid-cols-1 max-md:px-5 place-items-center py-3 px-20 mt-2">
        <div className="text-left max-md:text-center">
          <h2 className="mb-4 text-gray-700 font-medium">Links Principais</h2>
        ...
        <div className="text-left max-md:text-center">
          <h2 className="mb-4 mt-4 text-gray-700 font-medium">Cases</h2>
          <ul className="text-gray-400 flex flex-col gap-2">
        ...
        <div className="text-left max-md:text-center">
          <h2 className="mb-4 mt-4 text-gray-700 font-medium">Materiais</h2>
          <ul className="text-gray-400 flex flex-col gap-2">
        ...
        <div>
          <h2 className="mb-4 mt-4 text-gray-700 font-medium">Siga a leadster</h2>
