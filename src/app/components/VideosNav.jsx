    ...
    <div className="pb-5 mb-10 border-b-2 border-solid border-b-gray-300/[.55] w-full">
      <nav className="flex justify-between">
        <ul className="flex gap-4 w-full">
          ...
          <li className="border border-solid p-2 rounded-2xl hover:bg-blue-500 hover:text-white grid items-center">
        ...
        <div className="flex items-center">
          ...
          <select className="border px-2 py-1 text-sm font-medium outline-none rounded-md">
