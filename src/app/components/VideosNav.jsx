    ...
    <div className="pb-5 mb-10 border-b-2 border-solid border-b-gray-300/[.55] w-full">
      <nav className="flex justify-between">
        <ul className="flex gap-4 max-md:gap-2 w-fit">
          <li className=" border border-solid px-2 py-0.5 text-sm max-md:text-xs rounded-2xl hover:bg-blue-500 hover:text-white grid items-center whitespace-nowrap">
